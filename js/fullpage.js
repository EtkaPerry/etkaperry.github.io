...
document.getElementById("ust").addEventListener("change", function(e) {
  ...
  window.location.href =
    dropdown.options[dropdown.selectedIndex].getAttribute("id") + ".html";
});
  ...
  function initialise(containerSelector, options) {
    var isLicenseValid =
      (options &&
        ...
        ).test(options.licenseKey)) ||
      document.domain.indexOf("alvarotrigo.com") > -1;
    ...
    function addTouchHandler() {
      if (isTouchDevice || isTouch) {
        ...
        $(WRAPPER_SEL)[0].removeEventListener(
          events.touchstart,
          touchStartHandler
        );
        $(WRAPPER_SEL)[0].removeEventListener(
        ...
        $(WRAPPER_SEL)[0].addEventListener(
          events.touchstart,
          touchStartHandler
        );
